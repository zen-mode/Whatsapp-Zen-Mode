...
var $Iq2i6 = parcelRequire("Iq2i6");
function $a710347b043a9afbf2b1358f573cb0fc$export$f6fa5ff82577cef1() {
    $13vOd.hide_WA_context_menu();
    $a710347b043a9afbf2b1358f573cb0fc$var$set_hide_contact(true);
...
function $a710347b043a9afbf2b1358f573cb0fc$var$set_hide_contact(hide) {
    if (!$38ck6.lastHoveredChat) {
        $7pCU8.process_error("Hover chat not define");
        return;
    }
    if (hide) $2Sxce.addHiddenChats($38ck6.lastHoveredChat);
...
async function $d7f1a4cf3de2ba79384e3686e0075a1c$var$attach_Zen_mode_UI() {
    ...
    const [ZenModeBtnEl, releaseNotesAreaEl, ] = $6W0Bp.construct_Zen_mode_UI();
