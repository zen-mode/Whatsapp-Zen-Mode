...
import { constructBatchModePopup } from "../../../../whatsapp/ui/BatchModePopup/BatchModePopup";
import { constructBatchModePopupOff } from "../../../../whatsapp/ui/BatchModePopup/BatchModePopupOff";
...
export function construct_Zen_mode_UI(): [
  ...
  const batchModeAreaEl = constructBatchModePopup();
  const batchModeAreaElOff = constructBatchModePopupOff();

  devprint("STATUS: UI constructed.");

  return [debugVersionInfoEl, ZMMenuButtonEl, releaseNotesAreaEl, visibilityShedulerAreaEl, offlineModeInfoEl, miniPreviewAreaEl, batchModeAreaEl, batchModeAreaElOff];
}
